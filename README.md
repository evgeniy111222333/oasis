# Oasis Roleplay — Клієнтська та Серверна кодова база (v26.1.2)
...
2. Виконайте команду:
   ...
   .\gradlew.bat build
   ```
3. Отриманий JAR-файл буде знаходитися за шляхом: `client-mod-gradle/build/libs/oasisauth-1.0.0.jar`.
